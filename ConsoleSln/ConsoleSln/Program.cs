...
namespace ConsoleSln
{
    class Program
    {
        ...
        {
            //Console.Write("sum(1,2,3,4,5,6) == {0}", sum(new int[]{1, 2, 3, 4, 5, 6}));
            //Console.Write("multiply(1,2,3,4,5,6) == {0}", multiply(new int[] { 1, 2, 3, 4, 5, 6 }));
            //Console.Write("factorial(5) == {0}", factorial(5));
            //Console.Write("palindrome(radar) == {0}", palindrome("radar"));
            //Console.Write("factorial(5) == {0}", factorial(5));
            //Console.Write("fizzBuzz == {0}", fizzBuzz());
           /* foreach (string foo in filterLongWords(6))
            {
                Console.Write("{0}\n", foo);
            }*/
            ...
            //Console.Write("\"Alice\" occurs {0} times.", countAlice());
